...
func TestSharedCounter_IgnoresNonNumericIDs(t *testing.T) {
	...
	if err := b.Plans().Save(&client.Plan{ID: "01KSHXYS3XDE12P1R7R8V183VJ", Subject: "legacy ulid plan", State: client.PlanStateDraft}); err != nil {
		t.Fatalf("seed ulid plan: %v", err)
	}
